  ...
  const generateWorkout = async () => {
    ...
    try {
      ...
      const requestBody: WorkoutGenerationRequest = {
        ...
        workout_focus: workoutFocus, // Pass the entire array of workout focus types
    ...
    <>
      ...
      <div className="mx-auto max-w-3xl px-2 pb-10">
        ...
        <motion.div
          ...
          className="rounded-lg border border-white/10 bg-white/5 backdrop-blur-xl overflow-hidden"
        >
          {/* Form Content */}
          <div className="p-3">
            {/* Error Message */}
            ...
            <div className="mb-3">
              <div className="flex justify-between items-center mb-1">
                <label className="text-xs font-medium text-white/80">Target Muscles</label>
                <span className="text-[10px] text-white/60 bg-white/10 px-1.5 py-0.5 rounded-md">
              ...
              <div className="flex flex-row flex-wrap gap-1.5 justify-center">
                {MUSCLE_GROUPS.map((group) => (
                  <button
                    ...
                    className={`h-7 px-2 rounded-full text-[9px] font-medium transition-colors ${
            ...
            <div className="mb-3">
              <div className="flex justify-between items-center mb-1">
                <label className="text-xs font-medium text-white/80">Workout Focus</label>
                <span className="text-[10px] text-white/60 bg-white/10 px-1.5 py-0.5 rounded-md">
                ...
                {WORKOUT_FOCUS.map((focus) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="text-[9px] font-medium">{focus.label}</span>
                    </button>
                  </Tooltip>
                ))}
              </div>
            ...
            {/* Exercise Count - Enhanced Slider */}
            <div className="mb-3">
              <div className="flex justify-between items-center mb-2">
                <label className="text-xs font-medium text-white/80">Exercises</label>
                <span className="text-xs font-medium px-2 py-0.5 rounded-full bg-fuchsia-500/20 text-fuchsia-300">{exerciseCount}</span>
              </div>
              <div className="relative">
                <input
                  ...
                  className="w-full h-2 bg-white/10 rounded-full appearance-none cursor-pointer 
                    ...
                    [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-fuchsia-400 [&::-webkit-slider-thumb]:shadow-md
                    [&::-moz-range-thumb]:h-4 [&::-moz-range-thumb]:w-4 [&::-moz-range-thumb]:border-none
                    [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:bg-fuchsia-400
                    focus:outline-none focus-visible:ring-2 focus-visible:ring-fuchsia-400/50"
                />
                <div className="flex justify-between mt-1 px-1 text-[9px] text-white/40">
                  <span>1</span>
                  <span>5</span>
                  <span>10</span>
                </div>
            ...
            <div className="mb-3">
              <div className="flex justify-between items-center mb-2">
                <label className="text-xs font-medium text-white/80">Special Instructions</label>
                {charCount > 0 && (
              ...
              <textarea
                ...
                className="w-full p-2 rounded-md border border-white/10 bg-white/5 text-white placeholder-white/40 
