              ...
              <>
                ...
                <div className="hidden md:flex items-center gap-2">
                  ...
                  <div className="flex items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-3 py-1.5 text-sm text-white/80">
                    ...
                    <span className="truncate max-w-32">{user.full_name || user.email?.split('@')[0]}</span>
                  </div>
                  {isAdmin && (
                    <Link href="/protected/admin">
                      <button className="flex items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-3 py-1.5 text-sm text-white/80 hover:bg-white/10 transition-colors focus-ring">
              ...
              <div className="px-4 py-4 space-y-2">
                ...
                {isAdmin && (
                  <Link
                    ...
                    onClick={() => setIsMenuOpen(false)}
                    className="flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-white/80 hover:text-white hover:bg-white/10 transition-colors focus-ring"
                  >
