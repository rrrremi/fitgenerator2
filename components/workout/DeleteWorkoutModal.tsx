  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-2">
      <motion.div
        ...
        className="rounded-lg border border-white/10 bg-white/5 backdrop-blur-2xl p-3 max-w-xs w-full"
      >
        ...
        <div className="flex justify-end gap-2">
          <button
            onClick={onCancel}
            className="rounded-md border border-white/10 bg-white/5 px-3 py-1 text-xs text-white/80 hover:bg-white/10 transition-colors"
            disabled={isDeleting}
          >
            {cancelLabel}
          </button>
