...
const Input = forwardRef<HTMLInputElement, InputProps>(
  ({ label, error, icon, className = '', ...props }, ref) => {
    ...
    const baseStyles = 'px-2.5 py-1.5 bg-white/5 border border-white/10 rounded-md text-white placeholder:text-white/40 focus:outline-none focus:border-fuchsia-500/50 w-full transition-all duration-200 text-sm'
