          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              <Link href="/protected/workouts">
                <button className="rounded-lg border border-white/10 bg-white/5 p-2 text-white/80 hover:bg-white/10 transition-colors">
                  ← Back
                </button>
              </Link>
            ...
            <form onSubmit={handleSearch} className="flex gap-2">
              <input
                ...
                className="rounded-lg border border-white/10 bg-white/5 px-3 py-1 text-sm text-white/90 placeholder-white/40"
              />
              <button
                type="submit"
                className="rounded-lg border border-white/10 bg-white/10 px-3 py-1 text-sm text-white/90 hover:bg-white/20"
              >
                Search
              </button>
            </form>
